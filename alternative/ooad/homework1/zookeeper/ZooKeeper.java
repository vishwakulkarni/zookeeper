...
public class ZooKeeper {
	...
	public static void wakeup_animal(List<Animal> animal_list) {
		...
		for (Animal a : animal_list) {
			if (a instanceof Cat) {
				System.out.println(a.getName() + ", " + a.getType() + ", " + a.catReact());
			}
			else {
				System.out.println(a.getName() + ", " + a.getType() + ", " + a.wakeup());
			}
	...
	public static void rollcall_animal(List<Animal> animal_list) {
		...
		for (Animal a : animal_list) {
			...
			System.out.println(a.getName() + ", " + a.getType() + ", " + a.makeNoise());
			}
		}
	}
	...
	public static void feed_animal(List<Animal> animal_list) {
		...
		for (Animal a : animal_list) {
			...
			System.out.println(a.getName() + ", " + a.getType() + ", " + a.eat());
			}
		}
	}
	...
	public static void exercise_animal(List<Animal> animal_list) {
		...
		for (Animal a : animal_list) {
			...
			System.out.println(a.getName() + ", " + a.getType() + ", " + a.roam());
			}
		}
	}
	...
	public static void shutdown(List<Animal> animal_list) {
		...
		for (Animal a : animal_list) {
			...
			System.out.println(a.getName() + ", " + a.getType() + ", " + a.sleep());
			}
		}
		System.out.println("======================");
	}
